...
public class BCN implements NationalI{
    private static final String NATIONAL = "Spain";
    private static final String PREFIX = "+34 ";
    private static final String CITY = "BCN";

    private String address;
    private String phone;
    private final String name;

    public BCN(String name, int phone, String street, int number, int floor, int door, String zipCode) {
        this.name = name;
