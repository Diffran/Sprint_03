...
public class XPhone implements PhoneI{
    private String phoneNumberFormat;
    private int phoneNumber;
    private static final String PREFIX = "+86 ";

    public XPhone(int phoneInt) throws  NullPointerException{
    ...
    public String correctPhoneFormat(int phoneNumber) throws NullPointerException{
        ...
        format = PREFIX + format.substring(0,2)+" "+format.substring(2,6)+" "+format.substring(6);
        return format;
    }
    @Override
